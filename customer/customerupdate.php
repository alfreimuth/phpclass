                                ...
                                if(!empty($_POST["txtPassword"])){
                                    if($_POST["txtPassword"]==$_POST["txtPasswordVerify"]){
                                        ...
                                        try{
                                            ...
                                            $sql = mysqli_prepare($con, "update customerListing set FirstName = ?, LastName = ?, Phone = ?, Email = ?, Address = ?, City = ?,Zip = ?, State = ?, Password = ? where CustomerID = ?");
                                            mysqli_stmt_bind_param($sql, "ssssssssss", $txtFName,$txtLName,$txtPhone, $txtEmail, $txtAddress, $txtCity, $txtZipCode, $txtState, $txtPassword, $txtID);
...
<main>
    ...
    <form method="post">
        <div class="gc">
            <div class="item1"><h3>Update or Delete Customer</h3></div>
            <div class="item2">First Name</div>
            <div class="item3"><input type="text" name="txtFName" id="txtFName" value="<?=$txtFName?>"/></div>
            <div class="item4">Last Name</div>
            <div class="item5"><input type="text" name="txtLName" id="txtLName" value="<?=$txtLName?>"/></div>
            <div class="item6">Phone Number</div>
            <div class="item7"><input type="text" name="txtPhone" id="txtPhone" value="<?=$txtPhone?>"/></div>
            <div class="item8">Email</div>
            <div class="item9"><input type="text" name="txtEmail" id="txtEmail" value="<?=$txtEmail?>"/></div>
            <div class="item10">Address</div>
            <div class="item11"><input type="text" name="txtAddress" id="txtAddress" value="<?=$txtAddress?>"/></div>
            <div class="item12">City</div>
            <div class="item13"><input type="text" name="txtCity" id="txtCity" value="<?=$txtCity?>"/></div>
            <div class="item14">Zip Code</div>
            <div class="item15"><input type="text" name="txtZipCode" id="txtZipCode" value="<?=$txtZipCode?>"/></div>
            <div class="item16">State</div>
            <div class="item17"><input type="text" name="txtState" id="txtState" value="<?=$txtState?>"/></div>
            <div class="item18">Password</div>
            <div class="item19"><input type="text" name="txtPassword" id="txtPassword" value="<?=$txtPassword?>"/></div>
            ...
            <div class="item22"><input type="submit" value="Update Customer" /> | <input type="button" value="Delete Customer" onclick="DeleteMovie('<?=$id?>')"></div>
        </div>
